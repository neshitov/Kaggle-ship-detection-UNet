''' Implementation and training of U-Net model for ship detection '''
import torch
import sys
import math
import pickle
...
train_names, val_names = train_test_split(
    all_names, test_size=0.05, random_state=42)
...
nonempty_train_names, nonempty_val_names = train_test_split(
    non_empty_names, test_size=0.05, random_state=42)
...
def detection_train(epochs):
    ...
    active_parameters = [
        par for par in rn.parameters() if par.requires_grad == True]
