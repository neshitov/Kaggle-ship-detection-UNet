...
src='test'
name1, name2 = '462549a01.jpg', '009c7f8ec.jpg'
img1, img2 = cv.imread(os.path.join(TEST,name1)), cv.imread(os.path.join(TEST,name2))
img1, img2 = cv.resize(img1,(IMG_SIZE,IMG_SIZE)), cv.resize(img2,(IMG_SIZE,IMG_SIZE))
...
ans1, ans2 = cv.resize(ans1,(ORIG_IMG_SIZE,ORIG_IMG_SIZE)), cv.resize(ans2,(ORIG_IMG_SIZE,ORIG_IMG_SIZE))

ans1, ans2 = Image.fromarray(np.uint8((ans1)*255)), Image.fromarray(np.uint8((ans2)*255))
ans1.save('mask1.png')
ans2.save('mask2.png')
